...
def start():
    ...
    root.wm_iconphoto(True, ImageTk.PhotoImage(image = Image.open(urllib.request.urlopen("https://raw.githubusercontent.com/CrazyFox7048/LVCAppStore/main/icon_SdC_icon.ico"))))
...
def DownloadStart(link, name, destination, shortcut, run, message, button, msg, msg1):
    ...
    if shortcut != "":
        ...
        shortcutTarget = "L:\\"+ shortcutTarget + ".lnk"
